...
<section class="vs-hero-wrapper  ">
    <div class="vs-hero-carousel" data-height="770" data-container="1900" data-slidertype="responsive"
        ...
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
            <img width="1920" height="770" src="assets/img/school/WhatsApp Image 2024-11-30 at 4.32.40 PM.jpeg"
                class="ls-bg" alt="bg" decoding="async">
            <ls-layer
            ...
            <p style="font-size:26px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Jost', sans-serif; color:#ffffff; width:711px; left:312px; top:438px; -webkit-background-clip:border-box;"
                class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                data-ls="offsetyin:100; delayin:500; easingin:easeOutQuint; offsetyout:100; easingout:easeOutQuint;">
                حاصلة على بكالوريوس في التربية تخصص رياض الأطفال عام 2011 <br> بخبرة مميزة في تعليم الأطفال، <br>
                تركز على تنمية مهاراتهم وشخصياتهم بطريقة مبتكرة</p>
            ...
            <h1 style="stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:90px; color:#ffffff; top:255px; left:50%; width:1200px; font-size:90px; -webkit-background-clip:border-box;"
                ...
                بكالوريوس تربيه <br> تخصص رياض اطفال ٢٠١١ </h1>
        ...
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:out; kenburnsscale:1.1;">
            <img width="1920" height="770" src="assets/img/school/WhatsApp Image 2024-11-30 at 4.32.40 PM (1).jpeg"
                class="ls-bg" alt="bg" decoding="async">
            <h1 style="font-size:60px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:60px; color:#ffffff; top:284px; left:312px; width:711px; -webkit-background-clip:border-box;"
                class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                data-ls="offsetxin:-100; delayin:200; easingin:easeOutQuint; offsetxout:-100; easingout:easeOutQuint;">
        ...
        <!-- Slide 3-->
        <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
            <img width="1920" height="770" src="assets/img/school/WhatsApp Image 2024-11-30 at 4.32.43 PM (1).jpeg"
                class="ls-bg" alt="bg" decoding="async">
            <h1 style="font-size:60px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:60px; color:#ffffff; top:284px; left:312px; width:711px; -webkit-background-clip:border-box;"
                class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                data-ls="offsetxin:-100; delayin:200; easingin:easeOutQuint; offsetxout:-100; easingout:easeOutQuint;">
                أفضل دراسة للأطفال</h1>
            <h1 style="font-size:60px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:60px; color:#ffffff; top:361px; left:312px; width:711px; -webkit-background-clip:border-box;"
                class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                data-ls="offsetxin:100; delayin:300; easingin:easeOutQuint; offsetxout:100; easingout:easeOutQuint;">
                والرعاية المستقبلية
        ...
        <div class="row gx-70 align-items-center">
            ...
            <div class="col-lg-6">
                <div class="img-box1">
                    ...
                    <div class="img-1 mega-hover"><img src="assets/img/school/kid-1.jpeg" alt="about"></div>
                    <div class="img-2 mega-hover"><img src="assets/img/school/kid-2.jpeg" alt="about"></div>
                    <div class="img-3 mega-hover"><img src="assets/img/school/kid-3.jpeg" alt="about"></div>
                    <div class="img-4 mega-hover"><img src="assets/img/school/kid-4.jpeg" alt="about"></div>
                </div>
            </div>

            <div class="col-lg-6 text-center text-lg-start">
                <h2 class="sec-title" style="text-align: right; font-size: 54px;">بيئة تعليمية مبتكرة لرعاية طفلك
                </h2>
                <p class="sec-text pe-xl-5 mb-4 pb-xl-3" style="text-align: right; font-size: 24px;">نسعى جاهدين
                    لتوفير تجربة تعليمية
                    ممتعة وآمنة للأطفال من جميع الأعمار. نقدم برامج تعليمية حديثة تهدف إلى تنمية مهارات الأطفال
                    الاجتماعية والعقلية والإبداعية، مع التركيز على تعزيز حب التعلم لديهم.</p>
                    ...
                    <div class="col-auto">
                        <div class="vs-media media-style1">
                            ...
                            <div class="media-body">
                                ...
                                <p class="media-title" style="text-align: right;">الأنشطة الخارجية</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="vs-media media-style1">
                            ...
                            <div class="media-body">
                                ...
                                <p class="media-title" style="text-align: right;">المعلمين المحبين</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between flex-row-reverse">
                <div class="col-lg-6 text-center text-lg-end">
                    <div class="img-box2">
                        <div class="transform-banner"><img src="assets/img/school/color.jpeg" alt="about"></div>
                        <div class="vs-circle jump"></div>
                    </div>
                </div>
                <div class="col-lg-6 text-center text-lg-start">
                    <h2 class="sec-title me-xxl-5">أفضل بداية لطفلك في الحياة</h2>
                    <p class="sec-text col-xl-10 pe-4 mb-4" style="text-align: right; font-size: 22px;">
                        نسعى دائماً لتقديم خدمات تعليمية شاملة تناسب الأطفال من جميع الأعمار، مع التركيز على تنمية
                        المهارات والإبداع في بيئة آمنة وممتعة.
                    </p>
                    <p class="sec-text col-xl-10 pe-4 mb-4" style="text-align: right; font-size: 22px;">
                        هدفنا هو تحويل التعلم إلى تجربة ممتعة وفعّالة، حيث يكتسب الأطفال المعرفة بأسلوب حديث ومبتكر
                        يُشجعهم على استكشاف قدراتهم وتحقيق طموحاتهم.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between text-center text-md-start">
                ...
                <div class="col-md-auto">
                    <div class="title-area">
                        <h2 class="sec-title">جميع الصفوف</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-3">
                    <div class="category-style1">
                        ...
                        <div class="category-grade">
                            <span class="grade-label">الفصل</span>
                            <span class="grade-name">{{ $loop->iteration }}</span>
                        </div>
                        <h3 class="category-name h4"><a href="class.html" class="text-inherit">{{ $item->title}}</a></h3>
                        <p class="category-label">{{ $item->note}}</p>
                    </div>
                </div>
                @endforeach
                    ...
                    <div class="class-content">
                        <h3 class="class-title">
                            <a class="text-inherit" href="class-details.html">
                                {{ $item->title ?? 'Unnamed Subject' }}
                            </a>
                        </h3>
                        <p class="class-info">
                            السن: <span class="info">{{ $item->note ?? 'No note available' }}</span>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row flex-row-reverse align-items-center gx-60">
            <div class="col-lg-6 text-center text-lg-start mb-40 mb-lg-0">
                <img src="assets/img/school/test.jpeg" alt="childrens" class="w-100">
            </div>
            <div class="col-lg-6">
                <div class="title-area text-center">
                    <h2 class="sec-title">اراء الوالدين</h2>
                </div>
                <div class="vs-carousel" data-fade="true" data-dots="true" data-xl-dots="true" data-ml-dots="true"
                    ...
                    <div class="testi-style1">
                        ...
                        <h3 class="testi-name h2" style="text-align: right;">{{ $item->title}}</h3>
                        <div class="testi-rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i
                                class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                        </div>
                        <p class="testi-text">{{ $item->note}}</p>
                    </div>
                    @endforeach
                </div>
            </div>
