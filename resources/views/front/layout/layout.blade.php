    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="{{ route('home')}}"><img src="{{ asset('assets/img/logo/SVG/AlAbkariAlSaghier_Logo_3.svg')}}" alt="Kiddino"></a>
            </div>
                    ...
                    <div class="col-auto d-none d-lg-block">
                        <div class="header-links style-white">
                            <ul>
                                ...
                                @else
                                <li>
                                    <a href="{{ route('user-login') }}"><i class="far fa-user-circle"></i>تسجيل الدخول</a>
                                </li>
                                @endif
                            </ul>
                        </div>
                    ...
                    <div class="row gx-3 align-items-center justify-content-between">
                        ...
                        <div class="col-8 col-sm-auto">
                            <div class="header-logo">
                                <a href="{{ route('home')}}">
                                    <img src="{{ asset('assets/img/logo/PNG/AlAbkariAlSaghier_Logo_3.png')}}" alt="logo">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gx-60 gy-4 text-center text-lg-start justify-content-between align-items-center">
                    ...
                    <div class="col-lg-auto">
                        <h3 class="h4 mb-0 text-white"><img src="{{ asset('assets/img/icon/check-list.svg')}}" alt="icon"
                                class="me-2">مدرسة سمسطا بنين 2 الجديدة
                        </h3>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="widget footer-widget">
                            <div class="widget-about">
                                ...
                                <p class="map-link">مركز سمسطا,محافظة بني سويف<img src="{{ asset('assets/img/icon/map.svg')}}"
                                        alt="svg"></p>
                                <div class="sidebar-gallery">
                                    <div class="gallery-thumb">
                                        <img src="{{ asset('assets/img/school/gal-2-1.jpg')}}" alt="Gallery Image" class="w-100">
                                        <a href="assets/img/widget/gal-2-1.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="{{ asset('assets/img/school/gal-2-2.jpg')}}" alt="Gallery Image" class="w-100">
                                        <a href="assets/img/widget/gal-2-2.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="{{ asset('assets/img/school/gal-2-3.jpg')}}" alt="Gallery Image" class="w-100">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="widget footer-widget">
                            ...
                            <div>
                                ...
                                <p class="footer-info"><a href="tel:{{ $item->phone ?? ''}}">{{ $item->phone ?? ''}}</a> :للتواصل
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row flex-row-reverse gy-3 justify-content-between align-items-center">
                    <div class="col-lg-auto">
                        <p class="copyright-text ">جميع الحقوق محفوظة لدي <a href="{{ route('home')}}">العبقري الصغير</a> &copy;
