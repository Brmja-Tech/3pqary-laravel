                ...
                <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex border-end bg-transparent">
                    <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent bg-none">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <img src="{{ asset('assets/img/logo/PNG/AlAbkariAlSaghier_Logo_3.png')}}" class="img-fluid auth-img-cover-login " width="850" alt="">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="form-body mt-4">
                                    <form class="row g-3">
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="email" class="form-control" id="inputEmailAddress" value="admin@admin.com">
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label for="inputChoosePassword" class="form-label">كلمة السر</label>
                                            <div class="input-group" id="show_hide_password">
                                                <input type="password" class="form-control" id="inputChoosePassword" value="1234567890" placeholder="Enter Password">
